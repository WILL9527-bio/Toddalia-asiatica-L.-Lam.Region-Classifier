...
When using this tool, you need to download four files: region_classifier_Ul.py, region_classifier.py, Test Set.xlsx, and Training Set.xlsx. After that, simply run region_classifier_Ul.py.
